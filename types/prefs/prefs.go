...
//
// The preference types are compatible with the [scaletail.com/cmd/viewer] and
// [scaletail.com/cmd/cloner] utilities. It is recommended to generate a read-only view
