...
TS_LINK_FAIL_REFLECT=0 (was <nil>)`,
			wantArgv: []string{
				...
				"-ldflags", "-X scaletail.com/version.longStamp=1.2.3-long -X scaletail.com/version.shortStamp=1.2.3 -X scaletail.com/version.gitCommitStamp=abcd -X scaletail.com/version.extraGitCommitStamp=defg '-extldflags=-static'",
				"./cmd/tailcontrol",
			},
		},
		{
...
TS_LINK_FAIL_REFLECT=0 (was <nil>)`,
			wantArgv: []string{
				...
				"-trimpath",
				"-tags=tailscale_go",
				"-ldflags", "-X scaletail.com/version.longStamp=1.2.3-long -X scaletail.com/version.shortStamp=1.2.3 -X scaletail.com/version.gitCommitStamp=abcd -X scaletail.com/version.extraGitCommitStamp=defg",
				"./cmd/tailcontrol",
			},
		},
		{
...
TS_LINK_FAIL_REFLECT=0 (was <nil>)`,
			wantArgv: []string{
				...
				"-trimpath",
				"-tags=tailscale_go",
				"-ldflags", "-X scaletail.com/version.longStamp=1.2.3-long -X scaletail.com/version.shortStamp=1.2.3 -X scaletail.com/version.gitCommitStamp=abcd -X scaletail.com/version.extraGitCommitStamp=defg -H windows -s",
				"./cmd/tailcontrol",
			},
		},
		{
...
TS_LINK_FAIL_REFLECT=0 (was <nil>)`,
			wantArgv: []string{
				...
				"-ldflags", "-X scaletail.com/version.longStamp=1.2.3-long -X scaletail.com/version.shortStamp=1.2.3 -X scaletail.com/version.gitCommitStamp=abcd -X scaletail.com/version.extraGitCommitStamp=defg -w",
				"./cmd/tailcontrol",
			},
		},
		{
...
TS_LINK_FAIL_REFLECT=0 (was <nil>)`,
			wantArgv: []string{
				...
				"-trimpath",
				"-tags=tailscale_go,osusergo,netgo",
				"-ldflags", "-X scaletail.com/version.longStamp=1.2.3-long -X scaletail.com/version.shortStamp=1.2.3 -X scaletail.com/version.gitCommitStamp=abcd -X scaletail.com/version.extraGitCommitStamp=defg '-extldflags=-static -L /my/glibc/path'",
				"./cmd/tailcontrol",
			},
		},
		{
