...
Filename: "{cmd}"; Parameters: "/C call ""{sys}\sc.exe"" stop Tailscale >NUL 2>NUL || exit /B 0"; Flags: runhidden waituntilterminated; StatusMsg: "正在停止 ScaleTail 服务..."
...
Filename: "{cmd}"; Parameters: "/C call ""{sys}\sc.exe"" start Tailscale >NUL 2>NUL || exit /B 0"; Flags: runhidden waituntilterminated; StatusMsg: "正在启动 ScaleTail 服务..."
...
Filename: "{cmd}"; Parameters: "/C call ""{sys}\sc.exe"" stop Tailscale >NUL 2>NUL || exit /B 0"; Flags: runhidden waituntilterminated; StatusMsg: "正在停止 ScaleTail 服务..."; RunOnceId: "StopService"
...
Filename: "{cmd}"; Parameters: "/C call ""{sys}\sc.exe"" delete Tailscale >NUL 2>NUL || exit /B 0"; Flags: runhidden waituntilterminated; StatusMsg: "正在删除 ScaleTail 服务..."; RunOnceId: "DeleteService"
...
procedure StopTailscaleBeforeFileOps();
begin
...
procedure CleanupCurrentUserTailscaleData();
begin
...
begin
  StopTailscaleBeforeFileOps();
  CleanupCurrentUserTailscaleData();
  Result := True;
end;
