...
func TestMkversion(t *testing.T) {
	...
	tests := []struct {
		...
		{mkInfo("abcdef", "defghi", otherDate, 1, 15, 0, 129), `
           ...
           VERSION_MSIPRODUCT_AMD64="79A3DED2-B49A-57AF-9D2C-E1C8C9C9060B"
           VERSION_MSIPRODUCT_ARM64="F928E7AC-056F-5470-BB8A-1C4531DB7A23"
           VERSION_MSIPRODUCT_X86="3EE2E149-FA2B-510A-907F-75B59DCB0FE3"`},
		{mkInfo("abcdef", "", otherDate, 1, 2, 0, 17), `
           VERSION_MAJOR=1
           VERSION_MINOR=2
           VERSION_PATCH=0
