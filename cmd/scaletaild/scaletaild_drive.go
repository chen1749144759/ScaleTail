...
// protocol. On UNIX and MacOS scaletaild environment, Taildrive spawns child
// scaletaild processes in serve-taildrive mode in order to access the fliesystem
