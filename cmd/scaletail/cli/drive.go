...
const (
	driveShareUsage   = "scaletail drive share <name> <path>"
	driveRenameUsage  = "scaletail drive rename <oldname> <newname>"
	driveUnshareUsage = "scaletail drive unshare <name>"
	driveListUsage    = "scaletail drive list"
)
...
// runDriveShare is the entry point for the "scaletail drive share" command.
...
// runDriveUnshare is the entry point for the "scaletail drive unshare" command.
...
// runDriveRename is the entry point for the "scaletail drive rename" command.
...
// runDriveList is the entry point for the "scaletail drive list" command.
...
Each share is identified by a name and points to a directory at a specific path. For example, to share the path /Users/me/Documents under the name "docs", you would run:
  ...
  $ scaletail drive share docs /Users/me/Documents
...
If you want a share to be accessed as a different user, you can use sudo to accomplish this. For example, to create the aforementioned share as "theuser", you could run:
  ...
  $ sudo -u theuser scaletail drive share docs /Users/theuser/Documents`
