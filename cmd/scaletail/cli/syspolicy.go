...
func init() {
	sysPolicyCmd = func() *ffcli.Command {
		return &ffcli.Command{
			...
			LongHelp:   "The 'scaletail syspolicy' command provides tools for diagnosing the MDM and system policy configuration.",
			ShortUsage: "scaletail syspolicy <subcommand>",
			UsageFunc:  usageFuncNoDefaultValues,
			Subcommands: []*ffcli.Command{
				{
					Name:       "list",
					ShortUsage: "scaletail syspolicy list",
					Exec:       runSysPolicyList,
					ShortHelp:  "Print effective policy settings",
					LongHelp:   "The 'scaletail syspolicy list' subcommand displays the effective policy settings and their sources (e.g., MDM or environment variables).",
				...
				{
					Name:       "reload",
					ShortUsage: "scaletail syspolicy reload",
					Exec:       runSysPolicyReload,
					ShortHelp:  "Force a reload of policy settings, even if no changes are detected, and prints the result",
					LongHelp:   "The 'scaletail syspolicy reload' subcommand forces a reload of policy settings, even if no changes are detected, and prints the result.",
					FlagSet: (func() *flag.FlagSet {
