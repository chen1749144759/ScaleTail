...
func configureKubeconfigCmd() *ffcli.Command {
	return &ffcli.Command{
		...
		ShortUsage: "scaletail configure kubeconfig <hostname-or-fqdn>",
...
func kubeconfigPath() (string, error) {
	if kubeconfig := os.Getenv("KUBECONFIG"); kubeconfig != "" {
		if version.IsSandboxedMacOS() {
			return "", errors.New("cannot read $KUBECONFIG on GUI builds of the macOS client: this requires the open-source scaletaild distribution")
		}
		var out string
