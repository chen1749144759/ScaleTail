...
var versionCmd = &ffcli.Command{
	Name:       "version",
	ShortUsage: "scaletail version [flags]",
...
var clientupdateLatestScaleTailVersion feature.Hook[func(string) (string, error)]
...
func runVersion(ctx context.Context, args []string) error {
	...
	if versionArgs.upstream {
		f, ok := clientupdateLatestScaleTailVersion.GetOk()
		if !ok {
