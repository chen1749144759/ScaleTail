...
> 当前 GitHub 仓库地址计划为：<https://github.com/chen1749144759/ScaleTail>
...
注意：为了兼容上游 `tailscaled install-system-daemon`，Windows 服务名仍然是 `Tailscale`。产品名、安装目录、快捷方式和主程序名已经改为 `ScaleTail`。
